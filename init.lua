...
local oredefs = {
	...
	rhodochrosite = {
		...
		makes = {ore = true, block = true, lump = true, ingot = true, chest = false},
		oredef = {clust_scarcity = moreores_rhodochrosite_chunk_size * moreores_rhodochrosite_chunk_size * moreores_rhodochrosite_chunk_size,
			clust_num_ores = moreores_rhodochrosite_ore_per_chunk,
			clust_size     = moreores_rhodochrosite_chunk_size,
			y_min     = moreores_rhodochrosite_min_depth,
			y_max     = moreores_rhodochrosite_max_depth
			},
		tools = {
			pick = {
				cracky = {times = {[1] = 2.25, [2] = 0.55, [3] = 0.35}, uses = 200, maxlevel= 1}
